...
public class CreateManyToManyBiDirRelationFeature extends
	...
	public CreateManyToManyBiDirRelationFeature(IFeatureProvider fp) {
	...
	@Override
	public ManyToManyBiDirRelation createRelation(IFeatureProvider fp, PictogramElement source, PictogramElement target) {
