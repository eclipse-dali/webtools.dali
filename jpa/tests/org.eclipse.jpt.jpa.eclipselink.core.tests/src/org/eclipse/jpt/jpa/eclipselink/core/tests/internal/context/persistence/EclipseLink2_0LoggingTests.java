...
public class EclipseLink2_0LoggingTests extends EclipseLink2_0PersistenceUnitTestCase
{
	...
	public static final String EJB_OR_METADATA_LOGGING_KEY = EclipseLinkLogging2_0.ECLIPSELINK_EJB_OR_METADATA_CATEGORY_LOGGING_LEVEL;
	public static final EclipseLinkLoggingLevel EJB_OR_METADATA_LOGGING_TEST_VALUE = EclipseLinkLoggingLevel.warning;
	public static final EclipseLinkLoggingLevel EJB_OR_METADATA_LOGGING_TEST_VALUE_2 = EclipseLinkLoggingLevel.info;

	public static final String METAMODEL_LOGGING_KEY = EclipseLinkLogging2_0.ECLIPSELINK_JPA_METAMODEL_CATEGORY_LOGGING_LEVEL;
	...
	protected void setUp() throws Exception {
		...
		this.logging.addPropertyChangeListener(EclipseLinkLogging2_0.EJB_OR_METADATA_CATEGORY_LOGGING_PROPERTY, propertyChangeListener);
		this.logging.addPropertyChangeListener(EclipseLinkLogging2_0.JPA_METAMODEL_CATEGORY_LOGGING_PROPERTY, propertyChangeListener);
