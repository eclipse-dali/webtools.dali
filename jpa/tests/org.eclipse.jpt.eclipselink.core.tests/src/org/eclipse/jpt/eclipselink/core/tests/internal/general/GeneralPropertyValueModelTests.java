 ...
 */
public class GeneralPropertyValueModelTests extends PersistenceUnitTestCase
{
	...
	public GeneralPropertyValueModelTests(String name) {
		super(name);
	}
	...
	private PropertyChangeListener buildExcludeEclipselinkOrmChangeListener() {
		return new PropertyChangeListener() {
			public void propertyChanged(PropertyChangeEvent e) {
				GeneralPropertyValueModelTests.this.excludeEclipselinkOrmEvent = e;
			}
		};
	}
