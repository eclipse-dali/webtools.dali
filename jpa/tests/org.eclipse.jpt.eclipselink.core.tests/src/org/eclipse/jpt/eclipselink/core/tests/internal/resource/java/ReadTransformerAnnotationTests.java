...
public class ReadTransformerAnnotationTests extends EclipseLinkJavaResourceModelTestCase {
	...
	public void testGetTransformerClass() throws Exception {
		...
		EclipseLinkReadTransformerAnnotation readTransformer = (EclipseLinkReadTransformerAnnotation) attributeResource.getSupportingAnnotation(EclipseLinkJPA.READ_TRANSFORMER);
