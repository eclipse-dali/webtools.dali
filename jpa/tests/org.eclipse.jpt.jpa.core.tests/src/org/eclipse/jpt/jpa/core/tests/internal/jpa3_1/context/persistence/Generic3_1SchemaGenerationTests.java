...
/**
 * JPA 3.1 schema generation tests.
 * <p>
 * {@link SchemaGeneration3_1} inherits all schema-generation properties from
 * {@link SchemaGeneration2_1} via the 3.0 and 2.2 extension chain.  These
 * tests verify that every property can be set, read back, and removed on a
 * JPA 3.1 project.
 */
@SuppressWarnings("nls")
public class Generic3_1SchemaGenerationTests extends PersistenceUnit3_1TestCase
{
	SchemaGeneration3_1 schemaGeneration;
	...
	// ********** constructors **********
	public Generic3_1SchemaGenerationTests(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.schemaGeneration = (SchemaGeneration3_1) this.subject.getSchemaGeneration();
