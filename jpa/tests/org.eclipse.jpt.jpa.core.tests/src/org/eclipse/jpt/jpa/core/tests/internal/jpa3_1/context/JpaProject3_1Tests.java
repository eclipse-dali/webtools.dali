...
/**
 * Tests for JPA 3.1 project behaviour.
 * <p>
 * Mirrors {@code JpaProject3_0Tests} but uses the JPA 3.1 platform.
 * JPA 3.1 adds {@code GenerationType.UUID}; all base project behaviour
 * is inherited from JPA 3.0.
 */
@SuppressWarnings("nls")
public class JpaProject3_1Tests
	extends Generic3_1ContextModelTestCase
{
	public JpaProject3_1Tests(String name) {
		super(name);
	}
