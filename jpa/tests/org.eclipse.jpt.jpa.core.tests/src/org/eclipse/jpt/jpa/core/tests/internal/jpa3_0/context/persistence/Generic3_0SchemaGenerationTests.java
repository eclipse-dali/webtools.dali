...
/**
 * JPA 3.0 schema generation tests.
 * <p>
 * {@link SchemaGeneration3_0} inherits all properties from
 * {@link SchemaGeneration2_1} (via the 2.2 extension chain).  These tests
 * verify that every schema-generation property can be set, read back, and
 * removed on a JPA 3.0 project using the {@code jakarta.persistence} namespace.
 */
@SuppressWarnings("nls")
public class Generic3_0SchemaGenerationTests extends PersistenceUnit3_0TestCase
{
	SchemaGeneration3_0 schemaGeneration;
	...
	public static final Boolean CREATE_DATABASE_SCHEMAS_TEST_VALUE = Boolean.TRUE;
	...
	// ********** constructors **********
	public Generic3_0SchemaGenerationTests(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.schemaGeneration = (SchemaGeneration3_0) this.subject.getSchemaGeneration();
