...
public class GenericOrmElementCollectionMapping2_0Tests extends Generic2_0ContextModelTestCase
{
	...
	public void testUpdateName() throws Exception {
		...
		OrmModifiablePersistentAttribute ormPersistentAttribute = ormPersistentType.addAttributeToXml(ormPersistentType.getAttributeNamed("id"), MappingKeys2_0.ELEMENT_COLLECTION_ATTRIBUTE_MAPPING_KEY);
...
//TODO	assertEquals(FetchType.EAGER, ((IBasicMapping) ormPersistentAttribute.getMapping()).getSpecifiedFetch());
	...
	public void testVirtualAttributeOverrides() throws Exception {
		...
		ListIterator<? extends AttributeOverride> virtualOverrides = attributeOverrideContainer.getVirtualOverrides().iterator();
