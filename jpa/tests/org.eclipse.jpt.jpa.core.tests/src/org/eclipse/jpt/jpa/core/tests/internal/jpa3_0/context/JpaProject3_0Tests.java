...
/**
 * Tests for JPA 3.0 project behaviour.
 * <p>
 * Mirrors {@code JpaProject2_1Tests} but uses {@code jakarta.persistence.*}
 * annotation constants ({@link JPA3_0}) so that the JPA 3.0 annotation
 * definition provider recognises the test types as JPA-managed types.
 */
@SuppressWarnings("nls")
public class JpaProject3_0Tests
	extends Generic3_0ContextModelTestCase
{
	public JpaProject3_0Tests(String name) {
		super(name);
	}
	...
	private ICompilationUnit createTestEntity() throws Exception {
		return this.createTestType("MyEntity", new DefaultAnnotationWriter() {
			...
			public Iterator<String> imports() {
				return IteratorTools.iterator(JPA3_0.ENTITY);
			}
			@Override
	...
	private ICompilationUnit createTestMappedSuperclass() throws Exception {
		return this.createTestType("MyMappedSuperclass", new DefaultAnnotationWriter() {
			@Override
			public Iterator<String> imports() {
				return IteratorTools.iterator(JPA3_0.MAPPED_SUPERCLASS);
			}
			@Override
			public void appendTypeAnnotationTo(StringBuilder sb) {
	...
	private ICompilationUnit createTestEmbeddable() throws Exception {
		return this.createTestType("MyEmbeddable", new DefaultAnnotationWriter() {
			@Override
			public Iterator<String> imports() {
				return IteratorTools.iterator(JPA3_0.EMBEDDABLE);
			}
			@Override
			public void appendTypeAnnotationTo(StringBuilder sb) {
	...
	private ICompilationUnit createTestConverter() throws Exception {
		return this.createTestType("MyConverter", new DefaultAnnotationWriter() {
			@Override
			public Iterator<String> imports() {
				return IteratorTools.iterator(JPA3_0.CONVERTER);
			}
			@Override
			public void appendTypeAnnotationTo(StringBuilder sb) {
				sb.append("@Converter");
	...
	public void testGetMappingFileResourceDifferentlyNamed() throws Exception {
