	...
	extends Generic2_0ContextModelTestCase
{
	...
	public void testGetMapKeyColumn() throws Exception {
		...
		assertEquals("MY_PRIMARY_TABLE", manyToManyMapping.getMapKeyColumn().getTableName());
	...
	public void testMapKeyValueMoveSpecifiedAttributeOverride() throws Exception {
		...
		ListIterator<JavaSpecifiedAttributeOverride> specifiedOverrides = mapKeyAttributeOverrideContainer.getSpecifiedOverrides().iterator();
	...
	public void testSetSpecifiedMapKeyEnumerated() throws Exception {
		...
		assertNull(manyToManyMapping.getMapKeyConverter().getConverterType());
	...
	public void testSpecifiedMapKeyJoinColumns() throws Exception {
		...
		ListIterator<? extends SpecifiedJoinColumn> specifiedMapKeyJoinColumns = manyToManyMapping.getSpecifiedMapKeyJoinColumns().iterator();
	...
	public void testRemoveSpecifiedMapKeyJoinColumn() throws Exception {
		...
		Iterator<? extends SpecifiedJoinColumn> joinColumnsIterator = manyToManyMapping.getSpecifiedMapKeyJoinColumns().iterator();
	...
	public void testMoveSpecifiedJoinColumn() throws Exception {
		...
		ListIterator<? extends SpecifiedJoinColumn> joinColumns = manyToManyMapping.getSpecifiedMapKeyJoinColumns().iterator();
	...
	public void testUpdateSpecifiedMapKeyJoinColumns() throws Exception {
		...
		ListIterator<? extends SpecifiedJoinColumn> joinColumnsIterator = manyToManyMapping.getSpecifiedMapKeyJoinColumns().iterator();
		assertEquals("FOO", joinColumnsIterator.next().getName());
	...
	public void testMapKeyJoinColumnIsDefault() throws Exception {
		...
		manyToManyMapping.addSpecifiedMapKeyJoinColumn(0);
		SpecifiedJoinColumn specifiedJoinColumn = manyToManyMapping.getSpecifiedMapKeyJoinColumns().iterator().next();
