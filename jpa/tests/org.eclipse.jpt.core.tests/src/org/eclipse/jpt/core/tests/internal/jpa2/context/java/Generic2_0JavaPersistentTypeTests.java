...
public class Generic2_0JavaPersistentTypeTests extends Generic2_0ContextModelTestCase
{
	...
	public Generic2_0JavaPersistentTypeTests(String name) {
		super(name);
	}
	...
	public void testAccessPropertyAnnotatedFieldSpecified() throws Exception {
		...
		getJavaPersistentType().attributes().next().getResourcePersistentAttribute().setPrimaryAnnotation(TransientAnnotation.ANNOTATION_NAME, new String[0]);
