...
public class OrmEclipseLinkOneToOneMapping1_1UiProvider
	extends AbstractOneToOneMappingUiProvider<OrmEclipseLinkOneToOneMapping>
{
	// singleton
	private static final OrmEclipseLinkOneToOneMapping1_1UiProvider INSTANCE = 
		new OrmEclipseLinkOneToOneMapping1_1UiProvider();
	 ...
	 */
	private OrmEclipseLinkOneToOneMapping1_1UiProvider() {
		super();
	}
