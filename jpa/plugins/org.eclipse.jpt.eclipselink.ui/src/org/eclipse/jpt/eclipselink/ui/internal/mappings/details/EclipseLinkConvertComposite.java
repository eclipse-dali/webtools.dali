...
public class EclipseLinkConvertComposite extends FormPane<EclipseLinkConvert>
{
	...
	protected void initializeLayout(Composite container) {
		CCombo combo = addLabeledEditableCCombo(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_converterNameLabel,
		...
		Composite subSection = addCollapsableSubSection(
			container, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_defineConverterSection, 
			new SimplePropertyValueModel<Boolean>(Boolean.FALSE));
		
		// No Converter
		addRadioButton(
			subSection, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_default, 
		...
		addRadioButton(
			subSection, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_custom, 
		...
		addRadioButton(
			subSection, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_type, 
		...
		addRadioButton(
			subSection, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_objectType, 
		...
		addRadioButton(
			subSection, 
			EclipseLinkUiMappingsMessages.EclipseLinkConvertComposite_struct, 
