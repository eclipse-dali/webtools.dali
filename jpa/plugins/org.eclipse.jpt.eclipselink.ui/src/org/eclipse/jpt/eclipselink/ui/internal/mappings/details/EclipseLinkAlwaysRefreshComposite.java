...
public class EclipseLinkAlwaysRefreshComposite extends FormPane<EclipseLinkCaching>
{
	...
	protected void initializeLayout(Composite container) {
		...
		addTriStateCheckBoxWithDefault(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkAlwaysRefreshComposite_alwaysRefreshLabel,
		...
		return new TransformationPropertyValueModel<Boolean, String>(buildDefaultAlwaysRefreshHolder()) {
			...
			protected String transform(Boolean value) {
				if (value != null) {
					...
					return NLS.bind(EclipseLinkUiMappingsMessages.EclipseLinkAlwaysRefreshComposite_alwaysRefreshDefault, defaultStringValue);
				}
				return EclipseLinkUiMappingsMessages.EclipseLinkAlwaysRefreshComposite_alwaysRefreshLabel;
			}
		};
	}
