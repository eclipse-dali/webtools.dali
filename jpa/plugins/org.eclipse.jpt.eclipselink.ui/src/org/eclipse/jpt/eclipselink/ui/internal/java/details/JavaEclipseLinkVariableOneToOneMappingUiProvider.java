...
public class JavaEclipseLinkVariableOneToOneMappingUiProvider extends EclipseLinkVariableOneToOneMappingUiProvider<EclipseLinkVariableOneToOneMapping>
{
	// singleton
	private static final JavaEclipseLinkVariableOneToOneMappingUiProvider INSTANCE = 
		new JavaEclipseLinkVariableOneToOneMappingUiProvider();
	 ...
	 */
	private JavaEclipseLinkVariableOneToOneMappingUiProvider() {
		super();
	}
