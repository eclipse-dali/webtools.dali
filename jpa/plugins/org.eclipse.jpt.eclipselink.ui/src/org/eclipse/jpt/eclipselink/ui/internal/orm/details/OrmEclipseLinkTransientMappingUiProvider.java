...
public class OrmEclipseLinkTransientMappingUiProvider
	extends AbstractTransientMappingUiProvider<OrmTransientMapping>
{
	// singleton
	private static final OrmEclipseLinkTransientMappingUiProvider INSTANCE = 
		new OrmEclipseLinkTransientMappingUiProvider();
	 ...
	 */
	private OrmEclipseLinkTransientMappingUiProvider() {
		super();
	}
