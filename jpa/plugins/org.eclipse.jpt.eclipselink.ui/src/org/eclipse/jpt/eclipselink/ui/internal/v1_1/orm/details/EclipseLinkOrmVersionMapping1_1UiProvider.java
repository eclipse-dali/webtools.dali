...
public class EclipseLinkOrmVersionMapping1_1UiProvider
	extends AbstractVersionMappingUiProvider<EclipseLinkOrmVersionMapping>
{
	// singleton
	private static final EclipseLinkOrmVersionMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmVersionMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmVersionMapping1_1UiProvider() {
		super();
	}
