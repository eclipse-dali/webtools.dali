...
public class EclipseLinkOrmManyToManyMapping1_1UiProvider
	extends AbstractManyToManyMappingUiProvider<EclipseLinkOrmManyToManyMapping>
{
	// singleton
	private static final EclipseLinkOrmManyToManyMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmManyToManyMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmManyToManyMapping1_1UiProvider() {
		super();
	}
