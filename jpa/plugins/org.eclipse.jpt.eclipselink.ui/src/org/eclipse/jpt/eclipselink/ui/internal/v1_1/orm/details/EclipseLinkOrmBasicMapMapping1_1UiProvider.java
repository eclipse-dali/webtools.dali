...
public class EclipseLinkOrmBasicMapMapping1_1UiProvider extends EclipseLinkBasicMapMappingUiProvider<EclipseLinkBasicMapMapping>
{
	// singleton
	private static final EclipseLinkOrmBasicMapMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmBasicMapMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmBasicMapMapping1_1UiProvider() {
		super();
	}
