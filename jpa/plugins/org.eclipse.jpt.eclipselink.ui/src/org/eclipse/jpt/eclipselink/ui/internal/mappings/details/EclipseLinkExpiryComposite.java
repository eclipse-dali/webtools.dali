...
public class EclipseLinkExpiryComposite extends FormPane<EclipseLinkCaching> {
	...
	protected void initializeLayout(Composite container) {
		...
		Group expiryGroupPane = addTitledGroup(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_expirySection,
			2,
			null
		);
		...
		Button button = addRadioButton(
			expiryGroupPane,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_noExpiry,
			buildNoExpiryHolder(),
			null
		);
		...
		addRadioButton(
			expiryGroupPane,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_timeToLiveExpiry,
			buildExpiryHolder(),
			null
		);
		...
		addRadioButton(
			expiryGroupPane,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_dailyExpiry,
	...
	protected void addTimeToLiveComposite(Composite parent) {
		...
		Control expireAfterLabel = addUnmanagedLabel(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_timeToLiveExpiryExpireAfter
		);
	...
	protected void addTimeOfDayComposite(Composite parent) {
		...
		Control expireAtLabel = addUnmanagedLabel(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkExpiryComposite_timeOfDayExpiryExpireAt
		);
