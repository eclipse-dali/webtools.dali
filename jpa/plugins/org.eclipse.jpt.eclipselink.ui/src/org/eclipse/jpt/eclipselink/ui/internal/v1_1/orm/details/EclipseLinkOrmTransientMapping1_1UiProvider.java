...
public class EclipseLinkOrmTransientMapping1_1UiProvider
	extends AbstractTransientMappingUiProvider<OrmTransientMapping>
{
	// singleton
	private static final EclipseLinkOrmTransientMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmTransientMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmTransientMapping1_1UiProvider() {
		super();
	}
