...
public class EclipseLinkOrmEmbeddedMapping1_1UiProvider
	extends AbstractEmbeddedMappingUiProvider<OrmEmbeddedMapping>
{
	// singleton
	private static final EclipseLinkOrmEmbeddedMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmEmbeddedMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmEmbeddedMapping1_1UiProvider() {
		super();
	}
