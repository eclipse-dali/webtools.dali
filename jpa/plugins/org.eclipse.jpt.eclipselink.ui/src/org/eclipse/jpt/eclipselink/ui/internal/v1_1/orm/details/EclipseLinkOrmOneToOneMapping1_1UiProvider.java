...
public class EclipseLinkOrmOneToOneMapping1_1UiProvider
	extends AbstractOneToOneMappingUiProvider<EclipseLinkOrmOneToOneMapping>
{
	// singleton
	private static final EclipseLinkOrmOneToOneMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmOneToOneMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmOneToOneMapping1_1UiProvider() {
		super();
	}
