...
public class EclipseLinkDisableHitsComposite extends FormPane<EclipseLinkCaching>
{
	...
	protected void initializeLayout(Composite container) {
		...
		addTriStateCheckBoxWithDefault(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkDisableHitsComposite_disableHitsLabel,
		...
		return new TransformationPropertyValueModel<Boolean, String>(buildDefaultDisableHitsHolder()) {
			...
			protected String transform(Boolean value) {
				if (value != null) {
					...
					return NLS.bind(EclipseLinkUiMappingsMessages.EclipseLinkDisableHitsComposite_disableHitsDefault, defaultStringValue);
				}
				return EclipseLinkUiMappingsMessages.EclipseLinkDisableHitsComposite_disableHitsLabel;
			}
		};
	}
