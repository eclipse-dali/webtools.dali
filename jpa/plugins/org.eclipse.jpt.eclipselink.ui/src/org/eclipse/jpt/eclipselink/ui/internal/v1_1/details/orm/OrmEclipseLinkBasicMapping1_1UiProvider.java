...
{
	// singleton
	private static final OrmEclipseLinkBasicMapping1_1UiProvider INSTANCE = 
		new OrmEclipseLinkBasicMapping1_1UiProvider();
	 ...
	 */
	private OrmEclipseLinkBasicMapping1_1UiProvider() {
		super();
	}
