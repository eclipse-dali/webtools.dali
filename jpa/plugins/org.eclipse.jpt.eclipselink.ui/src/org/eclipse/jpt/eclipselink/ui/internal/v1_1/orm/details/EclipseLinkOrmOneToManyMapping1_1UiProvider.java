...
public class EclipseLinkOrmOneToManyMapping1_1UiProvider
	extends AbstractOneToManyMappingUiProvider<EclipseLinkOrmOneToManyMapping>
{
	// singleton
	private static final EclipseLinkOrmOneToManyMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmOneToManyMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmOneToManyMapping1_1UiProvider() {
		super();
	}
