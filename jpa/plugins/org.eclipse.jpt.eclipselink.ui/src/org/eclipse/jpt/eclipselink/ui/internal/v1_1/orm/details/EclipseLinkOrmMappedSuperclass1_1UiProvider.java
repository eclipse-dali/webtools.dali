...
public class EclipseLinkOrmMappedSuperclass1_1UiProvider 
	extends AbstractMappedSuperclassUiProvider<EclipseLinkOrmMappedSuperclass>
{
	// singleton
	private static final EclipseLinkOrmMappedSuperclass1_1UiProvider INSTANCE = 
		new EclipseLinkOrmMappedSuperclass1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmMappedSuperclass1_1UiProvider() {
		super();
	}
