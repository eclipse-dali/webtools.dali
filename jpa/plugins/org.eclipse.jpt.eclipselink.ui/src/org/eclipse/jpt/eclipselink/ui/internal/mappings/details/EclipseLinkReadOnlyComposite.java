...
public class EclipseLinkReadOnlyComposite extends FormPane<EclipseLinkReadOnly>
{
	...
	protected void initializeLayout(Composite container) {
		...
		addTriStateCheckBoxWithDefault(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkReadOnlyComposite_readOnlyLabel,
		...
		return new TransformationPropertyValueModel<Boolean, String>(buildDefaultReadOnlyHolder()) {
			...
			protected String transform(Boolean value) {
				if (value != null) {
					...
					return NLS.bind(EclipseLinkUiMappingsMessages.EclipseLinkReadOnlyComposite_readOnlyWithDefault, defaultStringValue);
				}
				return EclipseLinkUiMappingsMessages.EclipseLinkReadOnlyComposite_readOnlyLabel;
			}
		};
	}
