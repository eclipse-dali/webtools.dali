...
public class OrmEclipseLinkManyToOneMapping1_1UiProvider
	extends AbstractManyToOneMappingUiProvider<OrmEclipseLinkManyToOneMapping>
{
	// singleton
	private static final OrmEclipseLinkManyToOneMapping1_1UiProvider INSTANCE = 
		new OrmEclipseLinkManyToOneMapping1_1UiProvider();
	 ...
	 */
	private OrmEclipseLinkManyToOneMapping1_1UiProvider() {
		super();
	}
