...
public class EclipseLinkOrmVariableOneToOneMapping1_1UiProvider extends EclipseLinkVariableOneToOneMappingUiProvider<EclipseLinkVariableOneToOneMapping>
{
	// singleton
	private static final EclipseLinkOrmVariableOneToOneMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmVariableOneToOneMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmVariableOneToOneMapping1_1UiProvider() {
		super();
	}
