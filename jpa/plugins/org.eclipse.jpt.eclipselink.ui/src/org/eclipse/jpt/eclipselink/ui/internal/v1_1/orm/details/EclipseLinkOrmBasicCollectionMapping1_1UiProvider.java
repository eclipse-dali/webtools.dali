...
public class EclipseLinkOrmBasicCollectionMapping1_1UiProvider extends EclipseLinkBasicCollectionMappingUiProvider<EclipseLinkBasicCollectionMapping>
{
	// singleton
	private static final EclipseLinkOrmBasicCollectionMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmBasicCollectionMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmBasicCollectionMapping1_1UiProvider() {
		super();
	}
