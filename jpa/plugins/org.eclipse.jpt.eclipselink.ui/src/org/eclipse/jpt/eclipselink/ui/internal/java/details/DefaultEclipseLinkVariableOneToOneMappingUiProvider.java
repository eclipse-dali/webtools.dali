...
public class DefaultEclipseLinkVariableOneToOneMappingUiProvider
	implements DefaultAttributeMappingUiProvider<EclipseLinkJavaVariableOneToOneMapping>
{
	// singleton
	private static final DefaultEclipseLinkVariableOneToOneMappingUiProvider INSTANCE = 
		new DefaultEclipseLinkVariableOneToOneMappingUiProvider();
	
	/**
	 * Return the singleton.
	 */
	public static DefaultAttributeMappingUiProvider<EclipseLinkJavaVariableOneToOneMapping> instance() {
		return INSTANCE;
	}
	 ...
	 */
	private DefaultEclipseLinkVariableOneToOneMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
			...
			PropertyValueModel<EclipseLinkJavaVariableOneToOneMapping> subjectHolder,
			Composite parent,
