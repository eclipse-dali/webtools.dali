...
public class EclipseLinkMutableComposite extends FormPane<EclipseLinkMutable>
{
	...
	protected void initializeLayout(Composite container) {
		addTriStateCheckBoxWithDefault(
			container,
			EclipseLinkUiMappingsMessages.EclipseLinkMutableComposite_mutableLabel,
			buildMutableHolder(),
		...
		return new TransformationPropertyValueModel<Boolean, String>(buildDefaultMutableHolder()) {
			...
			protected String transform(Boolean value) {
				if (value != null) {
					...
					return NLS.bind(EclipseLinkUiMappingsMessages.EclipseLinkMutableComposite_mutableLabelDefault, defaultStringValue);
				}
				return EclipseLinkUiMappingsMessages.EclipseLinkMutableComposite_mutableLabel;
			}
		};
	}
