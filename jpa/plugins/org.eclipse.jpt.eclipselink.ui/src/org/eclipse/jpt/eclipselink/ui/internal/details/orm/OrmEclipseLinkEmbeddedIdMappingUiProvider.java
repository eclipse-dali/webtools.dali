...
public class OrmEclipseLinkEmbeddedIdMappingUiProvider
	extends AbstractEmbeddedIdMappingUiProvider<OrmEmbeddedIdMapping>
{
	// singleton
	private static final OrmEclipseLinkEmbeddedIdMappingUiProvider INSTANCE = 
		new OrmEclipseLinkEmbeddedIdMappingUiProvider();
	 ...
	 */
	private OrmEclipseLinkEmbeddedIdMappingUiProvider() {
		super();
	}
