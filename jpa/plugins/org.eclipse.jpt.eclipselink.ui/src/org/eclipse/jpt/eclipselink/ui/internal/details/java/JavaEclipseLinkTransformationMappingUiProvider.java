...
public class JavaEclipseLinkTransformationMappingUiProvider extends EclipseLinkTransformationMappingUiProvider<EclipseLinkTransformationMapping>
{
	// singleton
	private static final JavaEclipseLinkTransformationMappingUiProvider INSTANCE = 
		new JavaEclipseLinkTransformationMappingUiProvider();
	 ...
	 */
	private JavaEclipseLinkTransformationMappingUiProvider() {
		super();
	}
