...
public class EclipseLinkOrmBasicMapping1_1UiProvider
	extends AbstractBasicMappingUiProvider<EclipseLinkOrmBasicMapping>
{
	// singleton
	private static final EclipseLinkOrmBasicMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmBasicMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmBasicMapping1_1UiProvider() {
		super();
	}
