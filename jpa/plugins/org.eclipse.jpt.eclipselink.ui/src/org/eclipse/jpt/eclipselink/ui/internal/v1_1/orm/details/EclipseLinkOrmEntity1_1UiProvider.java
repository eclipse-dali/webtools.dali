...
public class EclipseLinkOrmEntity1_1UiProvider 
	extends AbstractEntityUiProvider<EclipseLinkOrmEntity>
{
	// singleton
	private static final EclipseLinkOrmEntity1_1UiProvider INSTANCE = 
		new EclipseLinkOrmEntity1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmEntity1_1UiProvider() {
		super();
	}
