...
public class EclipseLinkJpaPlatformUi extends BaseJpaPlatformUi
{
	...
	public Iterator<AttributeMappingUiProvider<? extends AttributeMapping>> eclipseLinkOrmAttributeMappingUiProviders() {
		if (this.eclipseLinkOrmAttributeMappingUiProviders == null) {
			...
			this.eclipseLinkOrmAttributeMappingUiProviders.add(OrmManyToOneMappingUiProvider.instance());
			this.eclipseLinkOrmAttributeMappingUiProviders.add(OrmOneToManyMappingUiProvider.instance());
			this.eclipseLinkOrmAttributeMappingUiProviders.add(OrmOneToOneMappingUiProvider.instance());
			this.eclipseLinkOrmAttributeMappingUiProviders.add(OrmManyToManyMappingUiProvider.instance());
