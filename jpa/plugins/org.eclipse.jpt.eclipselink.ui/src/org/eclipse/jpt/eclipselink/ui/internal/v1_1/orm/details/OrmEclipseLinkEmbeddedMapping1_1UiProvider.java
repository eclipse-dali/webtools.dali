...
public class OrmEclipseLinkEmbeddedMapping1_1UiProvider
	extends AbstractEmbeddedMappingUiProvider<OrmEmbeddedMapping>
{
	// singleton
	private static final OrmEclipseLinkEmbeddedMapping1_1UiProvider INSTANCE = 
		new OrmEclipseLinkEmbeddedMapping1_1UiProvider();
	 ...
	 */
	private OrmEclipseLinkEmbeddedMapping1_1UiProvider() {
		super();
	}
