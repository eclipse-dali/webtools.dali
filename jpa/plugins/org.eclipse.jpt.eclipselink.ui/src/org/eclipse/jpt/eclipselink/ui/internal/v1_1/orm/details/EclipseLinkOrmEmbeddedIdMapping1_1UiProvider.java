...
public class EclipseLinkOrmEmbeddedIdMapping1_1UiProvider
	extends AbstractEmbeddedIdMappingUiProvider<OrmEmbeddedIdMapping>
{
	// singleton
	private static final EclipseLinkOrmEmbeddedIdMapping1_1UiProvider INSTANCE = 
		new EclipseLinkOrmEmbeddedIdMapping1_1UiProvider();
	 ...
	 */
	private EclipseLinkOrmEmbeddedIdMapping1_1UiProvider() {
		super();
	}
