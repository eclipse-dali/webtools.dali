...
public class EclipseLinkOrmXmlUiDefinition2_0
	extends AbstractOrmXmlResourceUiDefinition
{
	// singleton
	private static final ResourceUiDefinition INSTANCE = new EclipseLinkOrmXmlUiDefinition2_0();
	 ...
	 */
	private EclipseLinkOrmXmlUiDefinition2_0() {
		super();
	}
	...
	protected JpaUiFactory buildUiFactory() {
		return new EclipseLinkOrmXmlUiFactory2_0();
	}
	
	public boolean providesUi(JptResourceType resourceType) {
		return resourceType.equals(EclipseLinkOrmXmlDefinition2_0.instance().getResourceType());
	}
	...
	protected void addDetailsProvidersTo(List<JpaDetailsProvider> providers) {
		...
		providers.add(EclipseLinkEntityMappingsDetailsProvider2_0.instance());
	}
