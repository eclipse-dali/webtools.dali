...
import org.eclipse.jpt.jpa.eclipselink.ui.internal.persistence.EclipseLinkPersistenceXml2_0UiDefinition;
...
public class EclipseLinkJpaPlatformUiProvider2_3
	extends AbstractJpaPlatformUiProvider
{
	// singleton
	private static final JpaPlatformUiProvider INSTANCE = new EclipseLinkJpaPlatformUiProvider2_3();
	 ...
	 */
	private EclipseLinkJpaPlatformUiProvider2_3() {
		super();
	}
