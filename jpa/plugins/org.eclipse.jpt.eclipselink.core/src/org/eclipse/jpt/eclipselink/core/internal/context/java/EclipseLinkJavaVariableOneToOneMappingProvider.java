...
public class EclipseLinkJavaVariableOneToOneMappingProvider
	implements DefaultJavaAttributeMappingProvider
{

	// singleton
	private static final EclipseLinkJavaVariableOneToOneMappingProvider INSTANCE = new EclipseLinkJavaVariableOneToOneMappingProvider();
	 ...
	 */
	private EclipseLinkJavaVariableOneToOneMappingProvider() {
		super();
	}
