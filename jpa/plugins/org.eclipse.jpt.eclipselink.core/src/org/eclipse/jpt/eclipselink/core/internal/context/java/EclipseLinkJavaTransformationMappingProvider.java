...
public class EclipseLinkJavaTransformationMappingProvider
	implements JavaAttributeMappingProvider
{

	// singleton
	private static final EclipseLinkJavaTransformationMappingProvider INSTANCE = new EclipseLinkJavaTransformationMappingProvider();
	 ...
	 */
	private EclipseLinkJavaTransformationMappingProvider() {
		super();
	}
