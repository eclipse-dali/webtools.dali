 ...
 */
public class EclipseLinkVirtualXmlEmbedded1_1 extends XmlEmbedded
{
	...
	protected final EclipseLinkVirtualXmlEmbedded virtualXmlEmbedded;
		
	public EclipseLinkVirtualXmlEmbedded1_1(OrmTypeMapping ormTypeMapping, JavaEmbeddedMapping javaEmbeddedMapping) {
		super();
		this.ormTypeMapping = ormTypeMapping;
		this.javaAttributeMapping = javaEmbeddedMapping;
		this.virtualXmlEmbedded = new EclipseLinkVirtualXmlEmbedded(ormTypeMapping, javaEmbeddedMapping);
	}
