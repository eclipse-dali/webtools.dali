 ...
 * <ul>
 *   <li>{@link org.eclipse.jpt.eclipselink.core.resource.elorm.EntityResult#getDiscriminatorColumn <em>Discriminator Column</em>}</li>
 *   <li>{@link org.eclipse.jpt.eclipselink.core.resource.elorm.EntityResult#getEntityClass <em>Entity Class</em>}</li>
 *   <li>{@link org.eclipse.jpt.eclipselink.core.resource.elorm.EntityResult#getFieldResults <em>Field Results</em>}</li>
 * </ul>
 * </p>
 *
...
public class EntityResult extends AbstractJpaEObject implements JpaEObject
{
	...
	{
		return EclipseLinkOrmPackage.Literals.ENTITY_RESULT;
	}
	 ...
	 * @see org.eclipse.jpt.eclipselink.core.resource.elorm.EclipseLinkOrmPackage#getEntityResult_DiscriminatorColumn()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.jpt.eclipselink.core.resource.elorm.EntityResult#getDiscriminatorColumn <em>Discriminator Column</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setDiscriminatorColumn(String newDiscriminatorColumn)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EclipseLinkOrmPackage.ENTITY_RESULT__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn, discriminatorColumn));
	}
	 ...
	 * @see org.eclipse.jpt.eclipselink.core.resource.elorm.EclipseLinkOrmPackage#getEntityResult_EntityClass()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.jpt.eclipselink.core.resource.elorm.EntityResult#getEntityClass <em>Entity Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setEntityClass(String newEntityClass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EclipseLinkOrmPackage.ENTITY_RESULT__ENTITY_CLASS, oldEntityClass, entityClass));
	}

	/**
	 * Returns the value of the '<em><b>Field Results</b></em>' containment reference list.
	 * The list contents are of type {@link org.eclipse.jpt.eclipselink.core.resource.elorm.FieldResult}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.jpt.eclipselink.core.resource.elorm.EclipseLinkOrmPackage#getEntityResult_FieldResults()
	...
	public EList<FieldResult> getFieldResults()
	{
		...
		{
			fieldResults = new EObjectContainmentEList<FieldResult>(FieldResult.class, this, EclipseLinkOrmPackage.ENTITY_RESULT__FIELD_RESULTS);
		}
		return fieldResults;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case EclipseLinkOrmPackage.ENTITY_RESULT__FIELD_RESULTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case EclipseLinkOrmPackage.ENTITY_RESULT__DISCRIMINATOR_COLUMN:
				return getDiscriminatorColumn();
			case EclipseLinkOrmPackage.ENTITY_RESULT__ENTITY_CLASS:
