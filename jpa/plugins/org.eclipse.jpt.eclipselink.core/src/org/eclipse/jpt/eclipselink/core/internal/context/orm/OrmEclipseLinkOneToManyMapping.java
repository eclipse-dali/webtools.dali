	...
	implements EclipseLinkOneToManyMapping2_0
{
	...
	@Override
	public EclipseLinkOrmOneToManyRelationshipReference2_0 getRelationshipReference() {
		return (EclipseLinkOrmOneToManyRelationship) super.getRelationshipReference();
	}
