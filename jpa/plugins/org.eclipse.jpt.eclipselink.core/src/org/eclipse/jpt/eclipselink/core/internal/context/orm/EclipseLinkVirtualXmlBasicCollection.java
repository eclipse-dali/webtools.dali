 ...
 */
public class EclipseLinkVirtualXmlBasicCollection extends XmlBasicCollection
{
	...
	public EclipseLinkVirtualXmlBasicCollection(OrmTypeMapping ormTypeMapping, EclipseLinkJavaBasicCollectionMapping javaBasicCollectionMapping) {
		super();
