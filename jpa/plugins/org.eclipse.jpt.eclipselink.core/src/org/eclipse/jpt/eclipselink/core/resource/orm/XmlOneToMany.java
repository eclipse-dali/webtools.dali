 ...
 * @generated
 */
public class XmlOneToMany extends org.eclipse.jpt.core.resource.orm.XmlOneToMany implements XmlAttributeMapping, XmlPrivateOwned, XmlJoinFetch
{
	/**
	...
	public TextRange getPrivateOwnedTextRange() {
		return getElementTextRange(JPA.PRIVATE_OWNED);
	}
