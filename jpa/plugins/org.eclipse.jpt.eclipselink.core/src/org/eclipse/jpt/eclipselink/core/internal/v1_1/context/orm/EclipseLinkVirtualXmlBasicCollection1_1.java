 ...
 */
public class EclipseLinkVirtualXmlBasicCollection1_1 extends XmlBasicCollection
{
	protected OrmTypeMapping ormTypeMapping;
	
	protected final EclipseLinkJavaBasicCollectionMapping javaAttributeMapping;

	protected final EclipseLinkVirtualXmlBasicCollection virtualXmlBasicCollection;
		
	public EclipseLinkVirtualXmlBasicCollection1_1(OrmTypeMapping ormTypeMapping, EclipseLinkJavaBasicCollectionMapping javaBasicCollectionMapping) {
		super();
		this.ormTypeMapping = ormTypeMapping;
		this.javaAttributeMapping = javaBasicCollectionMapping;
		this.virtualXmlBasicCollection = new EclipseLinkVirtualXmlBasicCollection(ormTypeMapping, javaBasicCollectionMapping);
	}
