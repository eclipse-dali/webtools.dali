 ...
 */
public interface JavaJoinFetchable extends JavaJpaContextNode, JoinFetchable
{
	
	/**
	 * Initialize the JavaJoinFetchable context model object to match the JoinFetchAnnotation 
	...
	/**
	 * Update the JavaJoinFetchable context model object to match the JoinFetchAnnotation 
