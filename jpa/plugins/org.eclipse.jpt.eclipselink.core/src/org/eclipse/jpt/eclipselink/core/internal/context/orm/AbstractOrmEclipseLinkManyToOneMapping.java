...
public abstract class AbstractOrmEclipseLinkManyToOneMapping extends AbstractOrmManyToOneMapping<XmlManyToOne>
	implements EclipseLinkRelationshipMapping
{
	protected OrmEclipseLinkJoinFetch joinFetch;
	
	
	protected AbstractOrmEclipseLinkManyToOneMapping(OrmPersistentAttribute parent, XmlManyToOne resourceMapping) {
