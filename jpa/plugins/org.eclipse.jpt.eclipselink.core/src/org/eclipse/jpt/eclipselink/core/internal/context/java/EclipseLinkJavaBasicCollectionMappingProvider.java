...
public class EclipseLinkJavaBasicCollectionMappingProvider
	implements JavaAttributeMappingProvider
{

	// singleton
	private static final EclipseLinkJavaBasicCollectionMappingProvider INSTANCE = new EclipseLinkJavaBasicCollectionMappingProvider();
	 ...
	 */
	private EclipseLinkJavaBasicCollectionMappingProvider() {
		super();
	}
