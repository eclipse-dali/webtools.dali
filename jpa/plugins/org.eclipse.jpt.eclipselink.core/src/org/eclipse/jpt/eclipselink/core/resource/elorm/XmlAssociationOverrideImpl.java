...
public class XmlAssociationOverrideImpl extends AbstractJpaEObject implements XmlAssociationOverride
{
	...
	{
		return EclipseLinkOrmPackage.Literals.XML_ASSOCIATION_OVERRIDE_IMPL;
	}
	...
	public EList<XmlJoinColumn> getJoinColumns()
	{
		if (joinColumns == null)
		{
			joinColumns = new EObjectContainmentEList<XmlJoinColumn>(XmlJoinColumn.class, this, EclipseLinkOrmPackage.XML_ASSOCIATION_OVERRIDE_IMPL__JOIN_COLUMNS);
		}
		return joinColumns;
	}
	...
	/**
	 * Sets the value of the '{@link org.eclipse.jpt.eclipselink.core.resource.elorm.XmlAssociationOverrideImpl#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EclipseLinkOrmPackage.XML_ASSOCIATION_OVERRIDE_IMPL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case EclipseLinkOrmPackage.XML_ASSOCIATION_OVERRIDE_IMPL__NAME:
				return getName();
		}
