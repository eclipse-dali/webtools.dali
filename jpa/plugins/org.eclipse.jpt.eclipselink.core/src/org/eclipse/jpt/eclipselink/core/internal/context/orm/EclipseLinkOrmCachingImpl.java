...
public class EclipseLinkOrmCachingImpl extends AbstractXmlContextNode
	implements EclipseLinkOrmCaching
{
	...
	public EclipseLinkOrmCachingImpl(OrmTypeMapping parent, XmlCacheHolder resource, EclipseLinkJavaCaching javaCaching) {
		super(parent);
	...
	protected void update(EclipseLinkJavaCaching javaCaching) {
		XmlCache resourceCache = getResourceCache();
	...
	protected int defaultSize(EclipseLinkJavaCaching javaCaching) {
	...
	protected boolean defaultShared(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
	...
	protected boolean defaultAlwaysRefresh(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
	...
	protected boolean defaultRefreshOnlyIfNewer(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
	...
	protected boolean defaultDisableHits(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
	...
	protected EclipseLinkCacheType defaultType(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
			return DEFAULT_TYPE;
		}
	...
	protected EclipseLinkCacheCoordinationType defaultCoordinationType(EclipseLinkJavaCaching javaCaching) {
		if (javaCaching == null) {
	...
	protected EclipseLinkExistenceType defaultExistenceType(EclipseLinkJavaCaching javaCaching) {
