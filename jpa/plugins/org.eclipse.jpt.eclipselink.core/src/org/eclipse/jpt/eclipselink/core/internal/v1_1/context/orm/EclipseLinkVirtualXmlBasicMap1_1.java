 ...
 */
public class EclipseLinkVirtualXmlBasicMap1_1 extends XmlBasicMap
{
	protected OrmTypeMapping ormTypeMapping;
	
	protected final EclipseLinkJavaBasicMapMapping javaAttributeMapping;

	protected final EclipseLinkVirtualXmlBasicMap virtualXmlBasicMap;
		
	public EclipseLinkVirtualXmlBasicMap1_1(OrmTypeMapping ormTypeMapping, EclipseLinkJavaBasicMapMapping javaBasicMapMapping) {
		super();
		this.ormTypeMapping = ormTypeMapping;
		this.javaAttributeMapping = javaBasicMapMapping;
		this.virtualXmlBasicMap = new EclipseLinkVirtualXmlBasicMap(ormTypeMapping, javaBasicMapMapping);
	}
