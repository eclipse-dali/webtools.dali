...
public class EclipseLinkJavaBasicMapMappingProvider
	implements JavaAttributeMappingProvider
{

	// singleton
	private static final EclipseLinkJavaBasicMapMappingProvider INSTANCE = new EclipseLinkJavaBasicMapMappingProvider();
	 ...
	 */
	private EclipseLinkJavaBasicMapMappingProvider() {
		super();
	}
