 ...
 */
public class EclipseLinkVirtualXmlTransformation extends XmlTransformation
{
	...
	public EclipseLinkVirtualXmlTransformation(OrmTypeMapping ormTypeMapping, EclipseLinkJavaTransformationMapping javaTransformationMapping) {
		super();
