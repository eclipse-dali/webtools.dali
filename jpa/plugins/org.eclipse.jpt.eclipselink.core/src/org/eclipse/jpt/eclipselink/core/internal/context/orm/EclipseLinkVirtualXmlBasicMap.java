 ...
 */
public class EclipseLinkVirtualXmlBasicMap extends XmlBasicMap
{
	...
	public EclipseLinkVirtualXmlBasicMap(OrmTypeMapping ormTypeMapping, EclipseLinkJavaBasicMapMapping javaBasicMapMapping) {
		super();
