 ...
 */
public class OrmEclipseLinkEntityProvider
	implements OrmTypeMappingProvider
{
	// singleton
	private static final OrmTypeMappingProvider INSTANCE = new OrmEclipseLinkEntityProvider();
	 ...
	 */
	private OrmEclipseLinkEntityProvider() {
		super();
	}
	...
	public OrmTypeMapping buildMapping(OrmPersistentType parent, XmlTypeMapping resourceMapping, JpaFactory factory) {
		return ((EclipseLinkJpaFactory) factory).buildOrmEclipseLinkEntity(parent, (XmlEntity) resourceMapping);
	}
