	...
	implements OrmAttributeMappingProvider
{
	...
	public OrmAttributeMapping buildMapping(OrmPersistentAttribute parent, XmlAttributeMapping resourceMapping, JpaFactory factory) {
		return ((EclipseLink1_1JpaFactory) factory).buildOrmEclipseLinkEmbeddedIdMapping1_1(parent, (XmlEmbeddedId) resourceMapping);
	}

	public XmlAttributeMapping buildVirtualResourceMapping(OrmTypeMapping ormTypeMapping, JavaAttributeMapping javaAttributeMapping, JpaFactory factory) {
		return ((EclipseLink1_1JpaFactory) factory).buildVirtualEclipseLinkXmlEmbeddedId1_1(ormTypeMapping, (JavaEmbeddedIdMapping) javaAttributeMapping);
	}
