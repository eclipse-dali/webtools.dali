...
public class Generic2_0OrmMappedSuperclassMappingProvider
	implements OrmTypeMappingProvider
{
	// singleton
	private static final OrmTypeMappingProvider INSTANCE = new Generic2_0OrmMappedSuperclassMappingProvider();
	 ...
	 */
	private Generic2_0OrmMappedSuperclassMappingProvider() {
		super();
	}
