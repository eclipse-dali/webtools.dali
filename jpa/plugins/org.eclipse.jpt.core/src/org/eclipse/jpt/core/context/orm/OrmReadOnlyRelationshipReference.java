 ...
 * @since 2.2
 */
public interface OrmReadOnlyRelationshipReference
	extends ReadOnlyRelationshipReference, XmlContextNode
{
	OrmReadOnlyJoiningStrategy getPredominantJoiningStrategy();
}
