...
public class GenericJavaVirtualOverrideJoinColumnJoiningStrategy
	extends AbstractJavaJpaContextNode
	implements JavaVirtualJoinColumnJoiningStrategy
{
	...
	protected Iterable<JoinColumn> getOverriddenSpecifiedJoinColumns() {
		JoinColumnJoiningStrategy overriddenStrategy = this.getOverriddenStrategy();
		...
		implements ContextContainerTools.Adapter<JavaVirtualJoinColumn, JoinColumn>
	{
		public Iterable<JavaVirtualJoinColumn> getContextElements() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getSpecifiedJoinColumns();
		}
		public Iterable<JoinColumn> getResourceElements() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getOverriddenSpecifiedJoinColumns();
		}
		...
		public void moveContextElement(int index, JavaVirtualJoinColumn element) {
			GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.moveSpecifiedJoinColumn(index, element);
		}
		public void addContextElement(int index, JoinColumn resourceElement) {
			GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.addSpecifiedJoinColumn(index, resourceElement);
		}
		public void removeContextElement(JavaVirtualJoinColumn element) {
			GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.removeSpecifiedJoinColumn(element);
		}
	}
		...
		implements ReadOnlyJoinColumn.Owner
	{
		...
		public String getDefaultTableName() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getTableName();
		}
		...
		public String getAttributeName() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getAttributeName();
		}

		public TypeMapping getTypeMapping() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getRelationshipSource();
		}

		public Entity getRelationshipTarget() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.getRelationshipTargetEntity();
		}
		...
		public int joinColumnsSize() {
			return GenericJavaVirtualOverrideJoinColumnJoiningStrategy.this.joinColumnsSize();
		}
	}
}
