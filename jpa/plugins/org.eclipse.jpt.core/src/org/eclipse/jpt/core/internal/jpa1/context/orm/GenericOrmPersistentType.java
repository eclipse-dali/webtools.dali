	...
	implements OrmPersistentType
{
	...
	protected OrmTypeMapping buildTypeMapping(XmlTypeMapping resourceMapping) {
		...
		return mappingDefintion.buildContextMapping(this, resourceMapping, getXmlContextNodeFactory());
	}
	...
	public void makePersistentAttributeSpecified(OrmPersistentAttribute ormPersistentAttribute, String mappingKey) {
		...
		OrmAttributeMappingDefinition mappingDefintion = 
	...
	protected Attributes createResourceAttributes() {
		return EmfTools.create(
			...
			OrmPackage.eINSTANCE.getAttributes(), 
			Attributes.class);
	}
	...
	protected OrmPersistentAttribute addVirtualPersistentAttribute(JavaAttributeMapping javaAttributeMapping) {
		OrmAttributeMappingDefinition mappingDefintion = 
				getMappingFileDefinition().getOrmAttributeMappingDefinition(javaAttributeMapping.getKey());
		XmlAttributeMapping resourceMapping = 
			mappingDefintion.buildVirtualResourceMapping(getMapping(), javaAttributeMapping, getXmlContextNodeFactory());
