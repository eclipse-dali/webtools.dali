 ...
 */
public class Generic2_0VirtualXmlEmbedded extends XmlEmbedded
{
	...
	public Generic2_0VirtualXmlEmbedded(OrmTypeMapping ormTypeMapping, JavaEmbeddedMapping javaEmbeddedMapping) {
		super();
