 ...
 * @generated
 */
public abstract class AbstractTable extends JpaEObject implements IJpaEObject
{
	/**
	...
	{
		return OrmPackage.Literals.ABSTRACT_TABLE;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ABSTRACT_TABLE__NAME, oldName, name));
	}
	...
	public void setCatalog(String newCatalog)
	{
		...
		catalog = newCatalog;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ABSTRACT_TABLE__CATALOG, oldCatalog, catalog));
	}
	...
	public void setSchema(String newSchema)
	{
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ABSTRACT_TABLE__SCHEMA, oldSchema, schema));
	}
	...
	public EList<UniqueConstraint> getUniqueConstraints()
	{
		...
		{
			uniqueConstraints = new EObjectContainmentEList<UniqueConstraint>(UniqueConstraint.class, this, OrmPackage.ABSTRACT_TABLE__UNIQUE_CONSTRAINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case OrmPackage.ABSTRACT_TABLE__UNIQUE_CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case OrmPackage.ABSTRACT_TABLE__NAME:
				return getName();
			case OrmPackage.ABSTRACT_TABLE__CATALOG:
				return getCatalog();
			case OrmPackage.ABSTRACT_TABLE__SCHEMA:
				return getSchema();
			case OrmPackage.ABSTRACT_TABLE__UNIQUE_CONSTRAINTS:
