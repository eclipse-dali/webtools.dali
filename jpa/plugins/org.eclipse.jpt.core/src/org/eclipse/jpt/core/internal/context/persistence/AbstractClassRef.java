 ...
 */
public abstract class AbstractClassRef
	...
	implements ClassRef
{
	 ...
	 */
	protected AbstractClassRef(PersistenceUnit parent, XmlJavaClassRef classRef) {
	 ...
	 * an explicit entry in the persistence.xml.
	 */
	protected AbstractClassRef(PersistenceUnit parent, String className) {
		this(parent, null, className);
	}

	protected AbstractClassRef(PersistenceUnit parent, XmlJavaClassRef classRef, String className) {
		super(parent);
