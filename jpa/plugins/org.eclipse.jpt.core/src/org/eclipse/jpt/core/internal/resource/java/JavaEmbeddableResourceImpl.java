...
public class JavaEmbeddableResourceImpl extends AbstractJavaAnnotationResource<Type> implements JavaEmbeddableResource
{

	protected JavaEmbeddableResourceImpl(Type type, JpaPlatform jpaPlatform) {
