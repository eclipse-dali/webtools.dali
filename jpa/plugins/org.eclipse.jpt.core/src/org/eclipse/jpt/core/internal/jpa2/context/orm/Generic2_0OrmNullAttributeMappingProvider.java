...
public class Generic2_0OrmNullAttributeMappingProvider
	implements OrmAttributeMappingProvider
{
	// singleton
	private static final OrmAttributeMappingProvider INSTANCE = new Generic2_0OrmNullAttributeMappingProvider();
	 ...
	 */
	private Generic2_0OrmNullAttributeMappingProvider() {
		super();
	}
