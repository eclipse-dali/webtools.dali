 ...
 */
public class Generic2_0VirtualXmlManyToMany extends XmlManyToMany
{
	...
	public Generic2_0VirtualXmlManyToMany(OrmTypeMapping ormTypeMapping, JavaManyToManyMapping javaManyToManyMapping) {
		super();
