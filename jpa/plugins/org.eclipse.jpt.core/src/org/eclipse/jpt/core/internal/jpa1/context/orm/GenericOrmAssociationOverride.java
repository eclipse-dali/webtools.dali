...
import org.eclipse.jpt.core.internal.context.orm.GenericOrmAssociationOverrideRelationshipReference;
	...
	implements OrmAssociationOverride
{
	...
	public GenericOrmAssociationOverride(XmlContextNode parent, AssociationOverride.Owner owner, XmlAssociationOverride xmlAssociationOverride) {
		super(parent);
		this.owner = owner;
		this.relationshipReference = new GenericOrmAssociationOverrideRelationshipReference(this, xmlAssociationOverride);
