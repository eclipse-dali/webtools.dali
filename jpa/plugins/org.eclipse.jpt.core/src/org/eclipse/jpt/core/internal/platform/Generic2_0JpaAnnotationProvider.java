...
/**
 * Provides annotations for Generic 2.0 JPA platform which includes 
 * JPA 1.0 annotations and JPA 2.0 annotations
 */
public class Generic2_0JpaAnnotationProvider
	extends AbstractJpaAnnotationProvider
{
	// singleton
	private static final JpaAnnotationProvider INSTANCE = new Generic2_0JpaAnnotationProvider();
	 ...
	 */
	private Generic2_0JpaAnnotationProvider() {
		super();
	}
