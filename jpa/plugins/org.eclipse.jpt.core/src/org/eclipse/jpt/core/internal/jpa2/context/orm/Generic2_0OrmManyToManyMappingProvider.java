...
public class Generic2_0OrmManyToManyMappingProvider
	implements OrmAttributeMappingProvider
{
	// singleton
	private static final OrmAttributeMappingProvider INSTANCE = new Generic2_0OrmManyToManyMappingProvider();
	 ...
	 */
	private Generic2_0OrmManyToManyMappingProvider() {
		super();
	}
