...
public interface JoinColumnJoiningStrategy
	extends ReadOnlyJoinColumnJoiningStrategy, JoiningStrategy
{
	void initializeFrom(ReadOnlyJoinColumnJoiningStrategy oldStrategy);

	void initializeFromVirtual(ReadOnlyJoinColumnJoiningStrategy oldStrategy);
