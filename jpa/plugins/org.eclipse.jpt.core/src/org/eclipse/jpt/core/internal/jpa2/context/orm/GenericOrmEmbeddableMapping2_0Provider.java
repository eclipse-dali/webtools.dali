...
public class GenericOrmEmbeddableMapping2_0Provider
	implements OrmTypeMappingProvider
{
	// singleton
	private static final OrmTypeMappingProvider INSTANCE = new GenericOrmEmbeddableMapping2_0Provider();
	 ...
	 */
	private GenericOrmEmbeddableMapping2_0Provider() {
		super();
	}
	...
	public OrmTypeMapping buildMapping(OrmPersistentType parent, XmlTypeMapping resourceMapping, JpaFactory factory) {
		return ((JpaFactory2_0) factory).buildOrmEmbeddable2_0(parent, (XmlEmbeddable) resourceMapping);
	}
