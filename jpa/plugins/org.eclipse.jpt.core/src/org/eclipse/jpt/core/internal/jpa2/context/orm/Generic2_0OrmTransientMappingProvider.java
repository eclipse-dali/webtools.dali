...
public class Generic2_0OrmTransientMappingProvider
	implements OrmAttributeMappingProvider
{
	// singleton
	private static final OrmAttributeMappingProvider INSTANCE = new Generic2_0OrmTransientMappingProvider();
	 ...
	 */
	private Generic2_0OrmTransientMappingProvider() {
		super();
	}
