...
public class GenericOrmVirtualOverrideJoinColumnJoiningStrategy
	extends AbstractOrmXmlContextNode
	implements OrmVirtualJoinColumnJoiningStrategy
{
		...
		implements ContextContainerTools.Adapter<OrmVirtualJoinColumn, JoinColumn>
	{
		public Iterable<OrmVirtualJoinColumn> getContextElements() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getSpecifiedJoinColumns();
		}
		public Iterable<JoinColumn> getResourceElements() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getOverriddenSpecifiedJoinColumns();
		}
		...
		public void moveContextElement(int index, OrmVirtualJoinColumn element) {
			GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.moveSpecifiedJoinColumn(index, element);
		}
		public void addContextElement(int index, JoinColumn resourceElement) {
			GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.addSpecifiedJoinColumn(index, resourceElement);
		}
		public void removeContextElement(OrmVirtualJoinColumn element) {
			GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.removeSpecifiedJoinColumn(element);
		}
	}
		...
		implements ReadOnlyJoinColumn.Owner
	{
		...
		public String getDefaultTableName() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getTableName();
		}
		...
		public String getAttributeName() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getAttributeName();
		}

		public TypeMapping getTypeMapping() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getRelationshipSource();
		}

		public Entity getRelationshipTarget() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.getRelationshipTargetEntity();
		}
		...
		public int joinColumnsSize() {
			return GenericOrmVirtualOverrideJoinColumnJoiningStrategy.this.joinColumnsSize();
		}
	}
}
