	...
	implements OrmXmlMapper
{
	...
	private Translator createNameTranslator() {
		return new Translator(NAME, ORM_PKG.getSecondaryTable_Name(), DOM_ATTRIBUTE);
	}
	
	private Translator createCatalogTranslator() {
		return new Translator(CATALOG, ORM_PKG.getSecondaryTable_Catalog(), DOM_ATTRIBUTE);
	}
	
	private Translator createSchemaTranslator() {
		return new Translator(SCHEMA, ORM_PKG.getSecondaryTable_Schema(), DOM_ATTRIBUTE);
	}
	...
	private Translator createUniqueConstraintTranslator() {
		return new UniqueConstraintTranslator(UNIQUE_CONSTRAINT, ORM_PKG.getSecondaryTable_UniqueConstraints());
	}
}
