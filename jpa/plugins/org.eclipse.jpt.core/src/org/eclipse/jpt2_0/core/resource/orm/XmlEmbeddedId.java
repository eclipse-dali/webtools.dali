...
public class XmlEmbeddedId extends org.eclipse.jpt.core.resource.orm.XmlEmbeddedId implements XmlAttributeMapping
{
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_EMBEDDED_ID__ACCESS: return Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS: return Orm2_0Package.XML_EMBEDDED_ID__ACCESS;
				default: return -1;
			}
		}
