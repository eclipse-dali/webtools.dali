...
public class Generic2_0OrmEmbeddedIdMappingProvider
	implements OrmAttributeMappingProvider
{
	// singleton
	private static final OrmAttributeMappingProvider INSTANCE = new Generic2_0OrmEmbeddedIdMappingProvider();
	 ...
	 */
	private Generic2_0OrmEmbeddedIdMappingProvider() {
		super();
	}
