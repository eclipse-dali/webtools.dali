...
public class XmlManyToOne extends org.eclipse.jpt.core.resource.orm.XmlManyToOne implements XmlAttributeMapping
{
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_MANY_TO_ONE__ACCESS: return Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS: return Orm2_0Package.XML_MANY_TO_ONE__ACCESS;
				default: return -1;
			}
		}
