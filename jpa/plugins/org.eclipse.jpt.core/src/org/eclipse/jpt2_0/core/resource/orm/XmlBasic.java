 ...
 * @generated
 */
public class XmlBasic extends org.eclipse.jpt.core.resource.orm.XmlBasic implements XmlAttributeMapping
{
	/**
	...
	{
		return Orm2_0Package.Literals.XML_BASIC;
	}
	...
	/**
	 * Sets the value of the '{@link org.eclipse.jpt2_0.core.resource.orm.XmlBasic#getAccess <em>Access</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setAccess(AccessType newAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Orm2_0Package.XML_BASIC__ACCESS, oldAccess, access));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_BASIC__ACCESS: return Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlAttributeMapping.class)
		{
			...
			{
				case Orm2_0Package.XML_ATTRIBUTE_MAPPING__ACCESS: return Orm2_0Package.XML_BASIC__ACCESS;
				default: return -1;
			}
		}
	...
	public static Translator buildTranslator(String elementName, EStructuralFeature structuralFeature) {
		return new SimpleTranslator(
			elementName, 
			structuralFeature, 
			Orm2_0Package.eINSTANCE.getXmlBasic(), 
