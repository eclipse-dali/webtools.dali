...
/**
 * Provides annotations for EclipseLink 2.0 platform
 */
public class EclipseLinkJpaAnnotationDefinitionProvider2_0
	extends AbstractJpaAnnotationDefinitionProvider
{
	// singleton
	private static final JpaAnnotationDefinitionProvider INSTANCE = new EclipseLinkJpaAnnotationDefinitionProvider2_0();
	 ...
	 */
	private EclipseLinkJpaAnnotationDefinitionProvider2_0() {
		super();
	}
