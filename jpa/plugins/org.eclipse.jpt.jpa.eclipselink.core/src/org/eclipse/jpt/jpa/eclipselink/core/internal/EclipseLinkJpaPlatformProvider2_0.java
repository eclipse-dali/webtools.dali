...
import org.eclipse.jpt.jpa.eclipselink.core.internal.context.persistence.EclipseLinkPersistenceXmlDefinition2_0;
 ...
 */
public class EclipseLinkJpaPlatformProvider2_0
	extends AbstractJpaPlatformProvider
{
	// singleton
	private static final JpaPlatformProvider INSTANCE = new EclipseLinkJpaPlatformProvider2_0();
	 ...
	 */
	protected EclipseLinkJpaPlatformProvider2_0() {
		super();
	}
	...
	protected static final JptResourceType[] MOST_RECENT_SUPPORTED_RESOURCE_TYPES = new JptResourceType[] {
		...
		org.eclipse.jpt.jpa.eclipselink.core.internal.context.orm.EclipseLinkOrmXmlDefinition2_0.instance().getResourceType()
	};
	...
	protected static final JpaResourceDefinition[] RESOURCE_DEFINITIONS = new JpaResourceDefinition[] {
		...
		EclipseLinkPersistenceXmlDefinition2_0.instance(),
