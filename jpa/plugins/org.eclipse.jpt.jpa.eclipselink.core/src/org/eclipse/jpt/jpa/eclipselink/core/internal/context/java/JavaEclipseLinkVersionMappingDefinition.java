...
import org.eclipse.jpt.jpa.core.internal.context.java.AbstractJavaVersionMappingDefinition;

public class JavaEclipseLinkVersionMappingDefinition
	extends AbstractJavaVersionMappingDefinition
{
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE = new JavaEclipseLinkVersionMappingDefinition();
	 ...
	 */
	private JavaEclipseLinkVersionMappingDefinition() {
		super();
	}
