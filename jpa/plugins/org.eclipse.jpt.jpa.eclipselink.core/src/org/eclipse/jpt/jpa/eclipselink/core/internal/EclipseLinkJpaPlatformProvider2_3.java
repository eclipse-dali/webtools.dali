 ...
 */
public class EclipseLinkJpaPlatformProvider2_3
	extends AbstractJpaPlatformProvider
{
	// singleton
	private static final JpaPlatformProvider INSTANCE = new EclipseLinkJpaPlatformProvider2_3();
	 ...
	 */
	private EclipseLinkJpaPlatformProvider2_3() {
		super();
	}
	...
	protected static final JptResourceType[] MOST_RECENT_SUPPORTED_RESOURCE_TYPES = new JptResourceType[] {
		...
		org.eclipse.jpt.jpa.eclipselink.core.internal.context.orm.EclipseLinkOrmXmlDefinition2_3.instance().getResourceType(),
	};
