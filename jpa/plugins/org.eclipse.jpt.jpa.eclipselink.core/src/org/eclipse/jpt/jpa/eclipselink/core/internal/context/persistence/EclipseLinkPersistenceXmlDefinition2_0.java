...
public class EclipseLinkPersistenceXmlDefinition2_0
	extends AbstractPersistenceXmlDefinition
{
	// singleton
	private static final PersistenceXmlDefinition INSTANCE = new EclipseLinkPersistenceXmlDefinition2_0();
	 ...
	 */
	private EclipseLinkPersistenceXmlDefinition2_0() {
		super();
	}
