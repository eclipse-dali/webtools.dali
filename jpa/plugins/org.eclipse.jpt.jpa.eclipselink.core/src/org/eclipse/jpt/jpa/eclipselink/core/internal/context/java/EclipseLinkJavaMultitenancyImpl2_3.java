...
public class EclipseLinkJavaMultitenancyImpl2_3
	...
	implements EclipseLinkJavaMultitenancy2_3
{
	...
	public EclipseLinkJavaMultitenancyImpl2_3(EclipseLinkJavaNonEmbeddableTypeMapping parent) {
		super(parent);
	...
	public void validate(List<IMessage> messages, IReporter reporter) {
		...
		if (getSpecifiedType() == EclipseLinkMultitenantType2_3.TABLE_PER_TENANT && ! this.getJpaPlatformVersion().isCompatibleWithEclipseLinkVersion(EclipseLinkJpaPlatformFactory2_4.VERSION)) {
			messages.add(
