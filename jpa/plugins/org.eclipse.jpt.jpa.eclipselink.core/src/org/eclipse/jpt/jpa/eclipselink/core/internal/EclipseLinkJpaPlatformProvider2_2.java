 ...
 */
public class EclipseLinkJpaPlatformProvider2_2
	extends AbstractJpaPlatformProvider
{
	// singleton
	private static final JpaPlatformProvider INSTANCE = new EclipseLinkJpaPlatformProvider2_2();
	 ...
	 */
	private EclipseLinkJpaPlatformProvider2_2() {
		super();
	}
	...
	protected static final JptResourceType[] MOST_RECENT_SUPPORTED_RESOURCE_TYPES = new JptResourceType[] {
		...
		org.eclipse.jpt.jpa.eclipselink.core.internal.context.orm.EclipseLinkOrmXmlDefinition2_2.instance().getResourceType(),
	};
