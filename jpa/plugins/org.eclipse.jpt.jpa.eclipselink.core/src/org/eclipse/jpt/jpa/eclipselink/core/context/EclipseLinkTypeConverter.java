	...
	extends EclipseLinkConverter
{
	...
	/**
	 * A transformer that returns an {@link EclipseLinkTypeConverter} if the passed
	 * in {@link EclipseLinkConverter} can be cast as such;
	 * otherwise, it returns <code>null</code>.
	 */
	Transformer<EclipseLinkConverter, EclipseLinkTypeConverter> CONVERTER_TRANSFORMER = new ConverterTransformer<>(EclipseLinkTypeConverter.class);
}
