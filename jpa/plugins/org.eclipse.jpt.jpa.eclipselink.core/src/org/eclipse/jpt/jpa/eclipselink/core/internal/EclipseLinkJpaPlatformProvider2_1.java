 ...
 */
public class EclipseLinkJpaPlatformProvider2_1
	extends AbstractJpaPlatformProvider
{
	// singleton
	private static final JpaPlatformProvider INSTANCE = new EclipseLinkJpaPlatformProvider2_1();
	 ...
	 */
	private EclipseLinkJpaPlatformProvider2_1() {
		super();
	}
	...
	protected static final JptResourceType[] MOST_RECENT_SUPPORTED_RESOURCE_TYPES = new JptResourceType[] {
		...
		org.eclipse.jpt.jpa.eclipselink.core.internal.context.orm.EclipseLinkOrmXmlDefinition2_1.instance().getResourceType(),
	};
