 ...
 * @generated
 */
public class XmlConverter extends org.eclipse.jpt.jpa.core.resource.orm.XmlConverter implements XmlNamedConverter
{
	/**
	...
	/**
	 * Sets the value of the '{@link org.eclipse.jpt.jpa.eclipselink.core.resource.orm.XmlConverter#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	{
		if (baseClass == XmlNamedConverter.class)
		{
			switch (derivedFeatureID)
			{
				case EclipseLinkOrmPackage.XML_CONVERTER__NAME: return EclipseLinkOrmPackage.XML_NAMED_CONVERTER__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == XmlNamedConverter.class)
		{
			...
			{
				case EclipseLinkOrmPackage.XML_NAMED_CONVERTER__NAME: return EclipseLinkOrmPackage.XML_CONVERTER__NAME;
				default: return -1;
			}
		}
	...
	public static Translator buildTranslator(String elementName, EStructuralFeature structuralFeature) {
		return new SimpleTranslator(
			...
			EclipseLinkOrmPackage.eINSTANCE.getXmlConverter(),
	...
	//TODO put refactoring and code-assist in generic as well, subclass the generic implementation?
