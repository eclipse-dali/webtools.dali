...
public class JptJpaUiMessages {
	...
	public static String DatabaseSCHEMA_WIZARD_PAGE_title;
	public static String DatabaseSCHEMA_WIZARD_PAGE_desc;
	public static String DatabaseSCHEMA_WIZARD_PAGE_schemaSettings;
	public static String DatabaseSCHEMA_WIZARD_PAGE_addConnectionToProject;
	public static String DatabaseSCHEMA_WIZARD_PAGE_connectLink;
	public static String DatabaseSCHEMA_WIZARD_PAGE_schema;
	public static String DatabaseSCHEMA_WIZARD_PAGE_connectionInfo;
	public static String DatabaseSCHEMA_WIZARD_PAGE_schemaInfo;
