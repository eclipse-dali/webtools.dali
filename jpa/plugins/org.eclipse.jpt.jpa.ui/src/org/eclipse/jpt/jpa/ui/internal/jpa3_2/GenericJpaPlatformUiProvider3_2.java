 ...
 *
 ******************************************************************************/
package org.eclipse.jpt.jpa.ui.internal.jpa3_2;
...
import org.eclipse.jpt.jpa.ui.internal.jpa3_2.details.orm.OrmXmlUiDefinition3_2;
import org.eclipse.jpt.jpa.ui.internal.jpa3_2.persistence.PersistenceXmlUiDefinition3_2;
 ...
 * is initialized).
 */
public class GenericJpaPlatformUiProvider3_2 extends AbstractJpaPlatformUiProvider {

	// singleton
	private static final JpaPlatformUiProvider INSTANCE = new GenericJpaPlatformUiProvider3_2();
	 ...
	 */
	private GenericJpaPlatformUiProvider3_2() {
		super();
	}
	...
	protected void addResourceUiDefinitionsTo(List<ResourceUiDefinition> definitions) {
		...
		definitions.add(OrmXmlUiDefinition3_2.instance());
		...
		definitions.add(PersistenceXmlUiDefinition3_2.instance());
	}
}
