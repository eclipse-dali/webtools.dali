 ...
 *
 ******************************************************************************/
package org.eclipse.jpt.jpa.ui.internal.jpa3_2.persistence;
...
import org.eclipse.jpt.jpa.ui.internal.jpa3_0.persistence.PersistenceUnitSchemaGenerationEditorPageDefinition3_0;
import org.eclipse.jpt.jpa.ui.internal.jpa3_1.persistence.PersistenceUnitSchemaGenerationEditorPageDefinition3_1;
...
public class PersistenceXmlUiDefinition3_2 extends AbstractPersistenceResourceUiDefinition {
	// singleton
	private static final PersistenceResourceUiDefinition INSTANCE = new PersistenceXmlUiDefinition3_2();
	 ...
	 */
	private PersistenceXmlUiDefinition3_2() {
		super();
	}
	...
	protected void addEditorPageDefinitionsTo(List<JpaEditorPageDefinition> definitions) {
		...
		definitions.add(PersistenceUnitSchemaGenerationEditorPageDefinition3_1.instance());
	}

	public boolean providesUi(JptResourceType resourceType) {
		return resourceType.equals(GenericPersistenceXmlDefinition3_2.instance().getResourceType());
	}
