...
public class EmbeddableUiDefinition 
	extends AbstractMappingUiDefinition
{
	// singleton
	private static final EmbeddableUiDefinition INSTANCE = new EmbeddableUiDefinition();
	 ...
	 */
	private EmbeddableUiDefinition() {
		super();
	}
	...
	public JpaComposite buildMappingComposite(JpaUiFactory factory, PropertyValueModel<? extends JpaContextNode> mappingModel, PropertyValueModel<Boolean> enabledModel, Composite parentComposite, WidgetFactory widgetFactory, ResourceManager resourceManager) {
		return factory.createEmbeddableComposite((PropertyValueModel<Embeddable>) mappingModel, parentComposite, widgetFactory, resourceManager);
	}
}
