...
public class OrmXmlUiDefinition3_2 extends AbstractOrmXmlResourceUiDefinition {
	// singleton
	private static final ResourceUiDefinition INSTANCE = new OrmXmlUiDefinition3_2();
	 ...
	 */
	private OrmXmlUiDefinition3_2() {
		super();
	}

	@Override
	protected JpaUiFactory buildUiFactory() {
		return new GenericOrmXmlUiFactory3_2();
	}

	public boolean providesUi(JptResourceType resourceType) {
		return resourceType.equals(GenericOrmXmlDefinition3_2.instance().getResourceType());
	}
