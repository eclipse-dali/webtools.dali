 ...
 */
public class SchemaGenerationComposite3_0 extends Pane<SchemaGeneration3_0> {
	public SchemaGenerationComposite3_0(Pane<SchemaGeneration3_0> parent, Composite container) {
		super(parent, container);
	}

	public SchemaGenerationComposite3_0(Pane<?> parent, PropertyValueModel<SchemaGeneration3_0> schemaGenModel,
			Composite container) {
