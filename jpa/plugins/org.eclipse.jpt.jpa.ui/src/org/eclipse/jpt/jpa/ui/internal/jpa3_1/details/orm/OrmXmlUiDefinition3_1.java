...
public class OrmXmlUiDefinition3_1 extends AbstractOrmXmlResourceUiDefinition {
	// singleton
	private static final ResourceUiDefinition INSTANCE = new OrmXmlUiDefinition3_1();
	 ...
	 */
	private OrmXmlUiDefinition3_1() {
		super();
	}

	@Override
	protected JpaUiFactory buildUiFactory() {
		return new GenericOrmXmlUiFactory3_1();
	}

	public boolean providesUi(JptResourceType resourceType) {
		return resourceType.equals(GenericOrmXmlDefinition3_1.instance().getResourceType());
	}
