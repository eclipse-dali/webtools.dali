...
public class Orm2_0VersionMappingUiProvider
	extends AbstractVersionMappingUiProvider<OrmVersionMapping>
{
	// singleton
	private static final Orm2_0VersionMappingUiProvider INSTANCE = 
		new Orm2_0VersionMappingUiProvider();
	 ...
	 */
	private Orm2_0VersionMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0VersionMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
