...
public class Orm2_0EmbeddedIdMappingUiProvider
	extends AbstractEmbeddedIdMappingUiProvider<OrmEmbeddedIdMapping>
{
	// singleton
	private static final Orm2_0EmbeddedIdMappingUiProvider INSTANCE = 
		new Orm2_0EmbeddedIdMappingUiProvider();
	 ...
	 */
	private Orm2_0EmbeddedIdMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0EmbeddedIdMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
