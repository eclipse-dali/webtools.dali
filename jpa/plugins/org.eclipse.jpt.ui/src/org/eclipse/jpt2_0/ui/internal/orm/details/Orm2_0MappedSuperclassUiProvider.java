...
public class Orm2_0MappedSuperclassUiProvider 
	extends AbstractMappedSuperclassUiProvider<OrmMappedSuperclass>
{
	// singleton
	private static final Orm2_0MappedSuperclassUiProvider INSTANCE = 
		new Orm2_0MappedSuperclassUiProvider();
	 ...
	 */
	private Orm2_0MappedSuperclassUiProvider() {
		super();
	}
	...
	public JpaComposite buildPersistentTypeMappingComposite(JpaUiFactory factory, PropertyValueModel<OrmMappedSuperclass> subjectHolder, Composite parent, WidgetFactory widgetFactory) {
