 ...
 * @since 1.0
 */
public class Java2_0EntityComposite extends AbstractEntityComposite<JavaEntity>
{
	/**
	 ...
	 */
	public Java2_0EntityComposite(PropertyValueModel<? extends JavaEntity> subjectHolder,
	                           Composite parent,
