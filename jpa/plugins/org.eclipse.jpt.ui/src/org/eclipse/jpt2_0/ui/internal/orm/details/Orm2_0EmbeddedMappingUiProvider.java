...
public class Orm2_0EmbeddedMappingUiProvider
	extends AbstractEmbeddedMappingUiProvider<OrmEmbeddedMapping>
{
	// singleton
	private static final Orm2_0EmbeddedMappingUiProvider INSTANCE = 
		new Orm2_0EmbeddedMappingUiProvider();
	 ...
	 */
	private Orm2_0EmbeddedMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0EmbeddedMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
