...
public class Orm2_0OneToManyMappingUiProvider
	extends AbstractOneToManyMappingUiProvider<OrmOneToManyMapping>
{
	// singleton
	private static final Orm2_0OneToManyMappingUiProvider INSTANCE = 
		new Orm2_0OneToManyMappingUiProvider();
	 ...
	 */
	private Orm2_0OneToManyMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0OneToManyMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
