...
public class OrmManyToManyMapping2_0UiProvider
	extends AbstractManyToManyMappingUiProvider<OrmManyToManyMapping>
{
	// singleton
	private static final OrmManyToManyMapping2_0UiProvider INSTANCE = 
		new OrmManyToManyMapping2_0UiProvider();
	 ...
	 */
	private OrmManyToManyMapping2_0UiProvider() {
		super();
	}
