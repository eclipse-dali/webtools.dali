...
public class OrmOneToManyMappingUiProvider
	extends AbstractOneToManyMappingUiProvider<OrmOneToManyMapping>
{
	// singleton
	private static final OrmOneToManyMappingUiProvider INSTANCE = 
		new OrmOneToManyMappingUiProvider();
	 ...
	 */
	private OrmOneToManyMappingUiProvider() {
		super();
	}
