...
public class OrmTransientMappingUiProvider
	extends AbstractTransientMappingUiProvider<OrmTransientMapping>
{
	// singleton
	private static final OrmTransientMappingUiProvider INSTANCE = 
		new OrmTransientMappingUiProvider();
	 ...
	 */
	private OrmTransientMappingUiProvider() {
		super();
	}
