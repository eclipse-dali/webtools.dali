...
public class OrmOneToOneMappingUiProvider
	extends AbstractOneToOneMappingUiProvider<OrmOneToOneMapping>
{
	// singleton
	private static final OrmOneToOneMappingUiProvider INSTANCE = 
		new OrmOneToOneMappingUiProvider();
	 ...
	 */
	private OrmOneToOneMappingUiProvider() {
		super();
	}
