...
public class Orm2_0BasicMappingUiProvider
	extends AbstractBasicMappingUiProvider<OrmBasicMapping>
{
	// singleton
	private static final Orm2_0BasicMappingUiProvider INSTANCE = 
		new Orm2_0BasicMappingUiProvider();
	 ...
	 */
	private Orm2_0BasicMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0BasicMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
