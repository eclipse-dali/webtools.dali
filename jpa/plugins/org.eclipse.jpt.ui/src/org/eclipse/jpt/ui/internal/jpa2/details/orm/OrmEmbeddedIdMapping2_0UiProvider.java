...
public class OrmEmbeddedIdMapping2_0UiProvider
	extends AbstractEmbeddedIdMappingUiProvider<OrmEmbeddedIdMapping>
{
	// singleton
	private static final OrmEmbeddedIdMapping2_0UiProvider INSTANCE = 
		new OrmEmbeddedIdMapping2_0UiProvider();
	 ...
	 */
	private OrmEmbeddedIdMapping2_0UiProvider() {
		super();
	}
