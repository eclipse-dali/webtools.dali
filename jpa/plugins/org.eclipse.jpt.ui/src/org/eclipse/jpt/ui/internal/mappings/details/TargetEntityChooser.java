...
public class TargetEntityChooser extends BaseJpaController<IRelationshipMapping>
{
	...
	protected void engageListeners() {
		if (subject() != null) {
			subject().eAdapters().add(relationshipMappingListener);
		}
	}
	...
	protected void disengageListeners() {
		if (this.subject() != null) {
			this.subject().eAdapters().remove(relationshipMappingListener);
		}
	}
