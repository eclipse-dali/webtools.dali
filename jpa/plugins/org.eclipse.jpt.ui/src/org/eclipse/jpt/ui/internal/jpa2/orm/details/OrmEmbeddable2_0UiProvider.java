...
public class OrmEmbeddable2_0UiProvider 
	extends AbstractEmbeddableUiProvider<OrmEmbeddable>
{
	// singleton
	private static final OrmEmbeddable2_0UiProvider INSTANCE = 
		new OrmEmbeddable2_0UiProvider();
	 ...
	 */
	private OrmEmbeddable2_0UiProvider() {
		super();
	}
