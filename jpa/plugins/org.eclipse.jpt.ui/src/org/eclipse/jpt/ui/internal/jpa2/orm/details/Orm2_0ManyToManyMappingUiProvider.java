...
public class Orm2_0ManyToManyMappingUiProvider
	extends AbstractManyToManyMappingUiProvider<OrmManyToManyMapping>
{
	// singleton
	private static final Orm2_0ManyToManyMappingUiProvider INSTANCE = 
		new Orm2_0ManyToManyMappingUiProvider();
	 ...
	 */
	private Orm2_0ManyToManyMappingUiProvider() {
		super();
	}
	...
	public JpaComposite buildAttributeMappingComposite(
		...
		return new Orm2_0ManyToManyMappingComposite(subjectHolder, parent, widgetFactory);
	}
}
