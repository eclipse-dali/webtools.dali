...
public class OrmTransientMapping2_0UiProvider
	extends AbstractTransientMappingUiProvider<OrmTransientMapping>
{
	// singleton
	private static final OrmTransientMapping2_0UiProvider INSTANCE = 
		new OrmTransientMapping2_0UiProvider();
	 ...
	 */
	private OrmTransientMapping2_0UiProvider() {
		super();
	}
