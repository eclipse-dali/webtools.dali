...
public class JavaEmbeddedMappingUiProvider
	extends AbstractEmbeddedMappingUiProvider<JavaEmbeddedMapping>
{
	// singleton
	private static final JavaEmbeddedMappingUiProvider INSTANCE = 
		new JavaEmbeddedMappingUiProvider();
	
	/**
	 * Return the singleton.
	 */
	public static AttributeMappingUiProvider<JavaEmbeddedMapping> instance() {
		return INSTANCE;
	}
	 ...
	 */
	private JavaEmbeddedMappingUiProvider() {
		super();
	}
