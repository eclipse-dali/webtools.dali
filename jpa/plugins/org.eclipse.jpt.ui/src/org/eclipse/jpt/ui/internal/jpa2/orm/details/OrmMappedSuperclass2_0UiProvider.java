...
public class OrmMappedSuperclass2_0UiProvider 
	extends AbstractMappedSuperclassUiProvider<OrmMappedSuperclass>
{
	// singleton
	private static final OrmMappedSuperclass2_0UiProvider INSTANCE = 
		new OrmMappedSuperclass2_0UiProvider();
	 ...
	 */
	private OrmMappedSuperclass2_0UiProvider() {
		super();
	}
