 ...
 * @since 2.0
 */
public class NamedNativeQueriesComposite extends AbstractFormPane<Entity>
{
	 ...
	 */
	public NamedNativeQueriesComposite(AbstractFormPane<? extends Entity> parentPane,
	                                   Composite parent) {
	...
	private ListValueModel<NamedNativeQuery> buildNamedNativeQueriesListHolder() {
		return new ListAspectAdapter<Entity, NamedNativeQuery>(getSubjectHolder(), Entity.NAMED_NATIVE_QUERIES_LIST) {
			@Override
