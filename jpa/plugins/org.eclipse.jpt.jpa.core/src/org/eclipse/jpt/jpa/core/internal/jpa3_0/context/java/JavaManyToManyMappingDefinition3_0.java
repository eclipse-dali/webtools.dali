...
/**
 * JPA 3.0 many-to-many attribute mapping definition.
 * <p>
 * Extends {@link JakartaJavaAttributeMappingDefinitionAdapter} wrapping
 * {@link JavaManyToManyMappingDefinition2_0} so that annotation detection uses
 * {@code jakarta.persistence.ManyToMany} in JPA 3.x projects.
 */
public class JavaManyToManyMappingDefinition3_0
	extends JakartaJavaAttributeMappingDefinitionAdapter
{
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE =
			new JavaManyToManyMappingDefinition3_0();

	public static JavaAttributeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaManyToManyMappingDefinition3_0() {
		super(JavaManyToManyMappingDefinition2_0.instance());
	}
}
