...
/**
 * JPA 3.0 entity type mapping definition.
 * <p>
 * Wraps {@link JavaEntityDefinition2_0} via {@link JavaTypeMappingDefinitionWrapper},
 * overriding {@link #getAnnotationName()} to return {@code jakarta.persistence.Entity}
 * and translating all supporting annotation names to the {@code jakarta.persistence.*}
 * namespace, so that Dali correctly recognises entities in JPA 3.x projects.
 */
public class JavaEntityDefinition3_0
	extends JavaTypeMappingDefinitionWrapper
{
	...
	// singleton
	private static final JavaTypeMappingDefinition INSTANCE = new JavaEntityDefinition3_0();

	public static JavaTypeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaEntityDefinition3_0() {
		super();
	}
	...
	public String getAnnotationName() {
		return JPA.JAKARTA_PACKAGE + ".Entity"; //$NON-NLS-1$
	}
