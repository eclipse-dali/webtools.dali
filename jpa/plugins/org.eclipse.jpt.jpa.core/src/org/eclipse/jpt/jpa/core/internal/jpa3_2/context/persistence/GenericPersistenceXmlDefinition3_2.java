...
import org.eclipse.jpt.jpa.core.resource.persistence.v3_2.JPA3_2;

public class GenericPersistenceXmlDefinition3_2 extends AbstractPersistenceXmlDefinition {
	// singleton
	private static final PersistenceXmlDefinition INSTANCE = new GenericPersistenceXmlDefinition3_2();
	 ...
	 */
	private GenericPersistenceXmlDefinition3_2() {
		super();
	}

	public JptResourceType getResourceType() {
		return this.getResourceType(XmlPersistence.CONTENT_TYPE, JPA3_2.SCHEMA_VERSION);
	}
	...
	protected PersistenceXmlContextModelFactory buildContextModelFactory() {
		return new GenericPersistenceXmlContextModelFactory3_2();
	}
}
