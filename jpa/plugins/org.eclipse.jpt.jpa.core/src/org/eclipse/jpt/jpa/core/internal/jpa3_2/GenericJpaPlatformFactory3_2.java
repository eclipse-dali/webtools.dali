 ...
 * is initialized).
 */
public class GenericJpaPlatformFactory3_2 extends GenericJpaPlatformFactory3_1 {
	public static final String ID = "generic3_2"; //$NON-NLS-1$
	...
	public JpaPlatform buildJpaPlatform(JpaPlatform.Config config) {
		return new GenericJpaPlatform(config, this.buildJpaVersion(config.getJpaFacetVersion()),
				new GenericJpaFactory3_2(),
				new JpaAnnotationProvider(GenericJpaAnnotationDefinitionProvider3_0.instance()),
				GenericJpaPlatformProvider3_2.instance(), this.buildJpaPlatformVariation(), JPQLGrammar2_1.instance());
	}
}
