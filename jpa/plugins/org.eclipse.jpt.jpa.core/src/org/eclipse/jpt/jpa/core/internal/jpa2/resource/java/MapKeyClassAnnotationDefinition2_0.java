...
/**
 * <code>javax.persistence.MapKeyClass</code> / <code>jakarta.persistence.MapKeyClass</code>
 */
public final class MapKeyClassAnnotationDefinition2_0
	implements AnnotationDefinition
{
	private static final AnnotationDefinition INSTANCE =
			new MapKeyClassAnnotationDefinition2_0(JPA.JAVAX_PACKAGE);
	...
	public static AnnotationDefinition instance(String jpaPackage) {
		...
		return new MapKeyClassAnnotationDefinition2_0(jpaPackage);
	}

	private final String annotationName;

	private MapKeyClassAnnotationDefinition2_0(String jpaPackage) {
		super();
		this.annotationName = jpaPackage +
				MapKeyClassAnnotation2_0.ANNOTATION_NAME.substring(JPA.JAVAX_PACKAGE.length());
	}
