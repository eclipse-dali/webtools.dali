...
/**
 * JPA 3.0 embedded ID attribute mapping definition.
 * <p>
 * Extends {@link JakartaJavaAttributeMappingDefinitionAdapter} wrapping
 * {@link JavaEmbeddedIdMappingDefinition2_0} so that annotation detection uses
 * {@code jakarta.persistence.EmbeddedId} in JPA 3.x projects.
 */
public class JavaEmbeddedIdMappingDefinition3_0
	extends JakartaJavaAttributeMappingDefinitionAdapter
{
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE =
			new JavaEmbeddedIdMappingDefinition3_0();

	public static JavaAttributeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaEmbeddedIdMappingDefinition3_0() {
		super(JavaEmbeddedIdMappingDefinition2_0.instance());
	}
}
