...
public class GenericPersistenceXmlDefinition2_0
	extends AbstractPersistenceXmlDefinition
{
	// singleton
	private static final PersistenceXmlDefinition INSTANCE = new GenericPersistenceXmlDefinition2_0();
	 ...
	 */
	private GenericPersistenceXmlDefinition2_0() {
		super();
	}
