...
/**
 * JPA 3.0 many-to-one attribute mapping definition.
 * <p>
 * Extends {@link JakartaJavaAttributeMappingDefinitionAdapter} wrapping
 * {@link JavaManyToOneMappingDefinition2_0} so that annotation detection uses
 * {@code jakarta.persistence.ManyToOne} in JPA 3.x projects.
 */
public class JavaManyToOneMappingDefinition3_0
	extends JakartaJavaAttributeMappingDefinitionAdapter
{
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE =
			new JavaManyToOneMappingDefinition3_0();

	public static JavaAttributeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaManyToOneMappingDefinition3_0() {
		super(JavaManyToOneMappingDefinition2_0.instance());
	}
}
