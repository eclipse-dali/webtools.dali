...
/**
 * JPA 3.0 mapped superclass type mapping definition.
 * <p>
 * Wraps {@link JavaMappedSuperclassDefinition2_0} via {@link JavaTypeMappingDefinitionWrapper},
 * overriding {@link #getAnnotationName()} to return {@code jakarta.persistence.MappedSuperclass}
 * and translating all supporting annotation names to the {@code jakarta.persistence.*}
 * namespace, so that Dali correctly recognises mapped superclasses in JPA 3.x projects.
 */
public class JavaMappedSuperclassDefinition3_0
	extends JavaTypeMappingDefinitionWrapper
{
	...
	// singleton
	private static final JavaTypeMappingDefinition INSTANCE = new JavaMappedSuperclassDefinition3_0();

	public static JavaTypeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaMappedSuperclassDefinition3_0() {
		super();
	}
	...
	public String getAnnotationName() {
		return JPA.JAKARTA_PACKAGE + ".MappedSuperclass"; //$NON-NLS-1$
	}
