 ...
 * </ul>
 * A <em>virtual</em> override is not explicitly specified on
 * the override's parent (i.e. it occurs by default); while a
 * <em>specified</em> override is explicitly specified on the
 * override's parent.
 * <p>
