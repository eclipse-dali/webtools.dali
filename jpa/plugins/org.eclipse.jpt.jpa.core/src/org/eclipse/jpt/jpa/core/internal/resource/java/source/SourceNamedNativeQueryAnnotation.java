	...
	implements NamedNativeQueryAnnotation
{
	...
	private static final DeclarationAnnotationAdapter CONTAINER_DECLARATION_ANNOTATION_ADAPTER = JakartaAwareDeclarationAnnotationAdapter.forJavax(JPA.NAMED_NATIVE_QUERIES);
	private static final DeclarationAnnotationAdapter JAKARTA_DECLARATION_ANNOTATION_ADAPTER = JakartaAwareDeclarationAnnotationAdapter.forJakarta(JPA.JAKARTA_PACKAGE + JPA.NAMED_NATIVE_QUERY.substring(JPA.JAVAX_PACKAGE.length()));
	private static final DeclarationAnnotationAdapter JAKARTA_CONTAINER_DECLARATION_ANNOTATION_ADAPTER = JakartaAwareDeclarationAnnotationAdapter.forJakarta(JPA.JAKARTA_PACKAGE + JPA.NAMED_NATIVE_QUERIES.substring(JPA.JAVAX_PACKAGE.length()));
	...
	public static SourceNamedNativeQueryAnnotation buildJakartaSourceNamedNativeQueryAnnotation(JavaResourceAnnotatedElement parent, AnnotatedElement element, int index) {
		IndexedDeclarationAnnotationAdapter idaa = buildJakartaNamedNativeQueryDeclarationAnnotationAdapter(index);
		IndexedAnnotationAdapter iaa = buildNamedNativeQueryAnnotationAdapter(element, idaa);
		return new SourceNamedNativeQueryAnnotation(parent, element, idaa, iaa);
	}
	...
	private static IndexedDeclarationAnnotationAdapter buildJakartaNamedNativeQueryDeclarationAnnotationAdapter(int index) {
		return new CombinationIndexedDeclarationAnnotationAdapter(
				JAKARTA_DECLARATION_ANNOTATION_ADAPTER,
				JAKARTA_CONTAINER_DECLARATION_ANNOTATION_ADAPTER,
				index,
				JPA.JAKARTA_PACKAGE + JPA.NAMED_NATIVE_QUERY.substring(JPA.JAVAX_PACKAGE.length()));
	}
}
