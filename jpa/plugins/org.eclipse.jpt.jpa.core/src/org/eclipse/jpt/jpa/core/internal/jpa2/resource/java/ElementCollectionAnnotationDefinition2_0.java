...
/**
 * <code>javax.persistence.ElementCollection</code> / <code>jakarta.persistence.ElementCollection</code>
 */
public final class ElementCollectionAnnotationDefinition2_0
	implements AnnotationDefinition
{
	private static final AnnotationDefinition INSTANCE =
			new ElementCollectionAnnotationDefinition2_0(JPA.JAVAX_PACKAGE);
	...
	public static AnnotationDefinition instance(String jpaPackage) {
		...
		return new ElementCollectionAnnotationDefinition2_0(jpaPackage);
	}

	private final String annotationName;

	private ElementCollectionAnnotationDefinition2_0(String jpaPackage) {
		super();
		this.annotationName = jpaPackage +
				ElementCollectionAnnotation2_0.ANNOTATION_NAME.substring(JPA.JAVAX_PACKAGE.length());
	}
