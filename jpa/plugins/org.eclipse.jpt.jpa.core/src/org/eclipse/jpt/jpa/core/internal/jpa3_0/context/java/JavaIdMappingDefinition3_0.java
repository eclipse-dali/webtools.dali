...
/**
 * JPA 3.0 ID attribute mapping definition.
 * <p>
 * Extends {@link JakartaJavaAttributeMappingDefinitionAdapter} wrapping
 * {@link JavaIdMappingDefinition2_0} so that annotation detection uses
 * {@code jakarta.persistence.Id} in JPA 3.x projects.
 */
public class JavaIdMappingDefinition3_0
	extends JakartaJavaAttributeMappingDefinitionAdapter
{
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE =
			new JavaIdMappingDefinition3_0();

	public static JavaAttributeMappingDefinition instance() {
		return INSTANCE;
	}

	private JavaIdMappingDefinition3_0() {
		super(JavaIdMappingDefinition2_0.instance());
	}
}
