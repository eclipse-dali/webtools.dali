 ...
 */
public class CachingLinkedStack<E>
	implements Stack<E>, Cloneable, Serializable
{
	 ...
	 */
	public CachingLinkedStack(int cacheSize) {
		this(CachingLinkedStack.<E>buildNodeFactory(cacheSize));
	}
	...
	private CachingLinkedStack(NodeFactory<E> nodeFactory) {
		super();
	...
	@Override
	public CachingLinkedStack<E> clone() {
		CachingLinkedStack<E> clone = new CachingLinkedStack<>(this.nodeFactory.copy());
