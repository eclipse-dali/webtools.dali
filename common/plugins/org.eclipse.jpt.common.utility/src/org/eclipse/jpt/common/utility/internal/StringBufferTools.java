...
public final class StringBufferTools {
	 ...
	 */
	public static void repeat(StringBuffer sb, String string, int length) {
		if (length == 0) {
			return;
		}
		int stringLength = string.length();
	 ...
	 */
	private static void repeat(StringBuffer sb, String string, int length, int stringLength) {
		do {
			sb.append(string);
	...
	/**
	 * @see #repeat(StringBuffer, String, int)
	 */
	public static void repeat(StringBuffer sb, char[] string, int length) {
		if (length == 0) {
			return;
		}
		int stringLength = string.length;
	 ...
	 * assume the string must, indeed, be repeated
	 */
	private static void repeat(StringBuffer sb, char[] string, int length, int stringLength) {
		do {
			sb.append(string);
			length = length - stringLength;
		} while (stringLength <= length);
