 ...
 */
public final class InactiveCombinedExtendedCommandContext
	implements CombinedExtendedCommandContext, Serializable
{
	public static final CombinedExtendedCommandContext INSTANCE = new InactiveCombinedExtendedCommandContext();
	...
	private InactiveCombinedExtendedCommandContext() {
		super();
	}
