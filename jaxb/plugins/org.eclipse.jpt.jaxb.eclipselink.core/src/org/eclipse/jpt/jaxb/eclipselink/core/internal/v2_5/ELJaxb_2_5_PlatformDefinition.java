...
public class ELJaxb_2_5_PlatformDefinition
	 ...
	 */
	public static final String ID = "eclipselink_2_5"; //$NON-NLS-1$
	
	// singleton
	private static final JaxbPlatformDefinition INSTANCE = new ELJaxb_2_5_PlatformDefinition();
	...
	private ELJaxb_2_5_PlatformDefinition() {
		super();
	}
