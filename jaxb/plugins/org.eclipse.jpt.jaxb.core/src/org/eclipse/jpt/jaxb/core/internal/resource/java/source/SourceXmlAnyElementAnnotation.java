	...
	implements XmlAnyElementAnnotation
{
	...
	// ********** constructors **********
	public SourceXmlAnyElementAnnotation(JavaResourcePersistentAttribute parent, Attribute attribute) {
	...
	public SourceXmlAnyElementAnnotation(JavaResourcePersistentAttribute parent, Attribute attribute, DeclarationAnnotationAdapter daa, AnnotationAdapter annotationAdapter) {
	...
	private DeclarationAnnotationElementAdapter<Boolean> buildLaxAdapter(DeclarationAnnotationAdapter daa) {
		return ConversionDeclarationAnnotationElementAdapter.forBooleans(daa, JAXB.XML_ANY_ELEMENT__LAX, false); // false = do not remove annotation when empty
	}
